...
# 1. LOAD DATASET
CSV_FILE = "datasetfinal.csv"

df = pd.read_csv(CSV_FILE,encoding="latin1")

texts = df["label_name"].astype(str).tolist()
...
model.save_pretrained("aivshuman_detector")
tokenizer.save_pretrained("aivshuman_detector")

print(" Model saved in folder: aivshuman_detector")
